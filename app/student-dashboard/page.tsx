    ...
    setTimeout(() => {
      setStudentData({
        ...
        financialInfo: {
          ...
          feeBreakup: [
            { type: "Tuition Fee", amount: 50000, paid: 30000, pending: 20000 },
            { type: "Hostel Fee", amount: 30000, paid: 20000, pending: 10000 },
            { type: "Library Fee", amount: 5000, paid: 0, pending: 5000 }
          ],
          paymentHistory: [
            { id: "1", type: "Tuition Fee", amount: 15000, date: new Date(Date.now() - 30 * 86400000).toISOString(), status: "Paid", receiptNo: "RCPT2024001" },
            { id: "2", type: "Hostel Fee", amount: 10000, date: new Date(Date.now() - 15 * 86400000).toISOString(), status: "Paid", receiptNo: "RCPT2024002" },
            { id: "3", type: "Tuition Fee", amount: 15000, date: new Date(Date.now() - 10 * 86400000).toISOString(), status: "Paid", receiptNo: "RCPT2024003" },
            { id: "4", type: "Hostel Fee", amount: 10000, date: new Date(Date.now() - 5 * 86400000).toISOString(), status: "Paid", receiptNo: "RCPT2024004" }
          ],
          fines: [
            { type: "Library Fine", amount: 500, reason: "Late book return", date: new Date().toISOString() }
          ]
        },
        libraryInfo: {
          booksIssued: [
            { id: "1", title: "Data Structures", author: "Author A", issueDate: new Date(Date.now() - 10 * 86400000).toISOString(), dueDate: new Date(Date.now() + 5 * 86400000).toISOString() },
            { id: "2", title: "Algorithms", author: "Author B", issueDate: new Date(Date.now() - 5 * 86400000).toISOString(), dueDate: new Date(Date.now() + 10 * 86400000).toISOString() }
          ],
          history: [
            { id: "1", title: "Computer Networks", returnDate: new Date(Date.now() - 20 * 86400000).toISOString(), status: "Returned" }
          ]
        },
        issues: [
          { id: "1", type: "Hostel Maintenance", description: "AC not working in room", status: "Pending", date: new Date(Date.now() - 2 * 86400000).toISOString() },
          { id: "2", type: "Fee Related", description: "Requesting fee extension", status: "Resolved", date: new Date(Date.now() - 10 * 86400000).toISOString() }
        ]
      });
      setLoading(false);
    }, 1000);
